...
public class Main {
    ...
    public static int[] moverJugador(String[][] mapa, int[] posicionJugador, Scanner scanner, int saludJugador, int ataqueJugador, int saludEnemigo, int ataqueEnemigo, int[] posicionEnemigo) {
        try {
            ...
            System.out.println("Error: Entrada invalida. Porfavor ingresa una entrada valida (w, a, s, d)");
            return moverJugador(mapa, posicionJugador, scanner, saludJugador, ataqueJugador, saludEnemigo, ataqueEnemigo, posicionEnemigo);
        }
    }
    ...
    public static String obtenerMovimiento(Scanner scanner) {
        try {
            ...
            System.out.println("Error: Entrada invalida. Porfavor ingresa una entrada valida (w, a, s, d)");
            scanner.next();
            return obtenerMovimiento(scanner);
        }
    }
    ...
    public static int verificarPosicion(String[][] mapa, int[] nuevaPosicion, int[] posicionEnemigo, int saludJugador, int ataqueJugador, int saludEnemigo, int ataqueEnemigo, Scanner scanner) {
        try {
            ...
            System.out.println("Error: Posicion invalida, intente denuevo");
            return verificarPosicion(mapa, nuevaPosicion, posicionEnemigo, saludJugador, ataqueJugador, saludEnemigo, ataqueEnemigo, scanner);
        }
    }
    ...
    public static int iniciarCombate(int saludJugador, int ataqueJugador, int saludEnemigo, int ataqueEnemigo, Scanner scanner) {
        try {
            ...
            System.out.println("Error: Entrada invalida. Ingrese una entrada valida (atacar/huir)");
            scanner.next();
            return iniciarCombate(saludJugador, ataqueJugador, saludEnemigo, ataqueEnemigo, scanner);
        }
    }
    ...
    public static String obtenerAccionCombate(Scanner scanner) {
        try {
            ...
            System.out.println("Error: Entrada invalida. Ingrese una entrada valida (atacar/huir)");
            scanner.next();
            return obtenerAccionCombate(scanner);
        }
    }
    ...
    public static int abrirCofre(int saludJugador, Scanner scanner) {
        try {
            ...
            System.out.println("Error: Entrada invalida, ingrese (s/n)");
            scanner.next();
            return abrirCofre(saludJugador, scanner);
        }
    }
}
